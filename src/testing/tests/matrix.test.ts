...
import { bothDialects, eachDatabaseItself, freshProcess, notYetOnPostgres, pgliteOnly, postgresServer, sqliteOnly } from "../../../tools/matrix.mjs";
...
const named = [...bothDialects, ...eachDatabaseItself, ...freshProcess, ...pgliteOnly, ...postgresServer, ...sqliteOnly, ...notYetOnPostgres];
